...
public class ReflectiveFeign extends Feign {
  ...
  public static class BuildTemplateByResolvingArgs implements RequestTemplate.Factory {
    ...
    public BuildTemplateByResolvingArgs(MethodMetadata metadata, QueryMapEncoder queryMapEncoder) {
  ...
  public static class BuildFormEncodedTemplateFromArgs extends BuildTemplateByResolvingArgs {
    ...
    public BuildFormEncodedTemplateFromArgs(MethodMetadata metadata, Encoder encoder, QueryMapEncoder queryMapEncoder) {
  ...
  public static class BuildEncodedTemplateFromArgs extends BuildTemplateByResolvingArgs {
    ...
    public BuildEncodedTemplateFromArgs(MethodMetadata metadata, Encoder encoder, QueryMapEncoder queryMapEncoder) {
      super(metadata, queryMapEncoder);
      this.encoder = encoder;
    }

    @Override
    public RequestTemplate resolve(Object[] argv, RequestTemplate mutable,
                                      Map<String, Object> variables) {
